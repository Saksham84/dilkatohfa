...
export default function ProductListing({ occasion }: Props) {
    ...
    const filteredProducts = products.filter((product) => {
        if (occasion && occasion !== "all") {
            return product.occasion?.toLowerCase() === occasion.toLowerCase();
        }
        return true;
    });
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4 mb-8">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-full text-sm font-medium
               hover:bg-gray-50 transition focus:outline-none focus:ring-2 focus:ring-pink-400"
                        >
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none px-4 py-2.5 pr-10 bg-white border border-gray-300 rounded-full
