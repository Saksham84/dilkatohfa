    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="sticky top-24 bg-white rounded-3xl overflow-hidden shadow-lg relative">
              <img
                src={product.image}
                alt={product.name}
              ...
              {product.originalPrice && (
                <div className="absolute top-6 left-6 px-4 py-2 bg-red-500 text-white rounded-full">
                  {Math.round(
